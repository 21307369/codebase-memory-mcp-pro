...
extern const unsigned char _binary_assets_index_bA_QMliC_js_data[];
extern const unsigned int _binary_assets_index_bA_QMliC_js_size;
...
cbm_embedded_file_t CBM_EMBEDDED_FILES[] = {
    ...
    {"/assets/index-bA-QMliC.js", _binary_assets_index_bA_QMliC_js_data, 0, "application/javascript"},
...
static void __attribute__((constructor)) init_embedded_sizes(void) {
    ...
    files[1].size = _binary_assets_index_bA_QMliC_js_size;
